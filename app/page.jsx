        ...
        <div className="container-px grid items-center gap-10 lg:grid-cols-2">
              ...
              {[
                {
                  ...
                  text: "Evidence-based care delivered with empathy.",
                },
                {
                  icon: Award,
                  title: "Experienced Team",
                  text: "Fellowship-trained GPs and skilled nurses.",
                },
                {
                  icon: Users,
                ...
                },
                {
                  icon: CalendarCheck,
                  title: "Easy Booking",
                  text: "Online booking and on-site pathology.",
                },
              ].map((f, i) => (
                <li
                  key={i}
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2rem] shadow-soft ring-1 ring-slate-100">
            <Image
              ...
              alt="About Doctors at Farm Gate"
              fill
